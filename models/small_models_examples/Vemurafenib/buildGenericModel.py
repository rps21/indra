...
drug = 'SORAFENIB'
drugSentences = 'SORAFENIB dephosphorylates PDGFRA.'
expSentences = 'SORAFENIB dephosphorylates RPS6.'
...
#Run 
prior_model_stmts,expObservations = buildAndCleanPrior(drugTargets,modifiedNodes,model_genes,drug,drugSentences,expSentences)
