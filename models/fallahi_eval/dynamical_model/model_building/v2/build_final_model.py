...
#[Phosphorylation(AKT1(mods: (phosphorylation)), RAF1()),
# Phosphorylation(RAF1(mods: (phosphorylation)), JNK()),
# Phosphorylation(JNK(mods: (phosphorylation)), JUN(), S),

erk_model_st_reduced = erk_model_st_reduced + manual_stmts + manual_stmts2
