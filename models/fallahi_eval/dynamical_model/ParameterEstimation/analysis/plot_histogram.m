function [] = plot_histogram2( samples, cfg, figidx );
%PLOT_HISTOGRAM2 plot histograms of parameter samples
%
%  [] = plot_histogram2( samples, cfg )
%  [] = plot_histogram2( samples, cfg, figidx )
%  
...
while (p<=nparams)
    ...
    for c = 1:nchains
        ...
        %edges = logspace( log10(lb), log10(ub), res )';
