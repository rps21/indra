...
cfg.param_defs = { ...
  ...
  struct('name','egfr_lox','prior','point','value',log10(3000*4.7220864391),'units','?'), ...
  ...
  struct('name','egf_lox','prior','point','value',log10(10000*2.7983094633),'units','?'), ... 
  struct('name','phos_lox','prior','uniform','min',log10(1e3),'max',log10(1e6),'units','?'), ... 
  struct('name','kf_kb_act_1','prior','uniform','min',log10(1e-7),'max',log10(1e-5),'units','?'), ... 
  struct('name','kf_e_autophos_1','prior','uniform','min',log10(5e-1),'max',log10(5e2),'units','?'), ... 
  struct('name','kf_eg_bind_1','prior','uniform','min',log10(1e-7),'max',log10(1e-5),'units','?'), ... 
  struct('name','kr_eg_bind_1','prior','uniform','min',log10(1e-3),'max',log10(5e-1),'units','?'), ... 
  struct('name','kf_ee_bind_1','prior','uniform','min',log10(1e-7),'max',log10(1e-4),'units','?'), ... 
  ...
  struct('name','kf_sk_gef_1','prior','uniform','min',log10(1e-9),'max',log10(1e-6),'units','?'), ... 
  struct('name','kf_bm_bind_1','prior','uniform','min',log10(1e-8),'max',log10(1e-6),'units','?'), ... 
  struct('name','kr_bm_bind_1','prior','uniform','min',log10(1e-2),'max',log10(5),'units','?'), ... 
  struct('name','kc_bm_phosphorylation_1','prior','uniform','min',log10(1e-2),'max',log10(1e1),'units','?'), ... 
  struct('name','kf_bm_bind_2','prior','uniform','min',log10(5e-7),'max',log10(5e-5),'units','?'), ... 
  struct('name','kr_bm_bind_2','prior','uniform','min',log10(1e-4),'max',log10(1e-2),'units','?'), ... 
  struct('name','kc_bm_phosphorylation_2','prior','uniform','min',log10(1e-1),'max',log10(5e1),'units','?'), ... 
  struct('name','kf_bm_bind_3','prior','uniform','min',log10(1e-7),'max',log10(1e-4),'units','?'), ... 
  ...
  struct('name','kf_mm_bind_1','prior','uniform','min',log10(5e-8),'max',log10(5e-6),'units','?'), ... 
  struct('name','kr_mm_bind_1','prior','uniform','min',log10(5e-3),'max',log10(5e-1),'units','?'), ... 
  struct('name','kc_mm_phosphorylation_1','prior','uniform','min',log10(1e-5),'max',log10(1),'units','?'), ... 
  struct('name','kf_mm_bind_2','prior','uniform','min',log10(1e-7),'max',log10(1e-5),'units','?'), ... 
  struct('name','kr_mm_bind_2','prior','uniform','min',log10(5e-4),'max',log10(1e-2),'units','?'), ... 
  ...
  struct('name','kf_mm_bind_3','prior','uniform','min',log10(5e-7),'max',log10(1e-4),'units','?'), ... 
  struct('name','kr_mm_bind_3','prior','uniform','min',log10(1e-3),'max',log10(1e-1),'units','?'), ... 
  ...
  struct('name','kc_mb_phosphorylation_2','prior','uniform','min',log10(1e-1),'max',log10(1e1),'units','?'), ... 
  ...
  struct('name','kf_drug_braf','prior','uniform','min',log10(5e-9),'max',log10(1e-6),'units','?'), ... 
  struct('name','kr_drug_braf','prior','uniform','min',log10(1e-4),'max',log10(1e-2),'units','?'), ... 
  struct('name','mapk1_p_decay_slow','prior','uniform','min',log10(1e-6),'max',log10(1e-3),'units','?'), ... 
  struct('name','kf_erk_phos','prior','uniform','min',log10(5e-6),'max',log10(5e-2),'units','?'), ... 
  struct('name','kr_erk_phos','prior','uniform','min',log10(1e-3),'max',log10(1e-1),'units','?'), ... 
  struct('name','kc_erk_phos','prior','uniform','min',log10(1e-1),'max',log10(1e1),'units','?'), ... 
  struct('name','kf_drug_phos','prior','uniform','min',log10(1),'max',log10(1e4),'units','?'), ... 
  struct('name','kr_drug_phos','prior','uniform','min',log10(1e-9),'max',log10(1e-5),'units','?'), ... 
   struct('name','map2k1_decay_slow','prior','uniform','min',log10(1e-1),'max',log10(1e4),'units','?'), ...
...
cfg.data{4}.time = [cfg.sim_tstart : cfg.sim_dt : cfg.sim_tstop]'; 
cfg.data{5}.time = [cfg.sim_tstart : cfg.sim_dt : cfg.sim_tstop]'; 
cfg.data{6}.time = [cfg.sim_tstart : cfg.sim_dt : cfg.sim_tstop]';
...
cfg.data{3}.mean = pmek_lox_mean(:,7);
...
cfg.maxlabs  = 5;                      % maximum number of labs for parallel computing
cfg.nchains  = 5;                      % number of chains
...
cfg.energy_init_max = 150;             % maximum allowed energy for initialization
