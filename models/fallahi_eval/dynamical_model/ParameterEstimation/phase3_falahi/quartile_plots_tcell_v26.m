function [training] = quartile_plots_tcell_v23(pars,cfg,tag,suppress_plot)
...
for i = 1:numtraj
    ...
    init(18) = 0;    %drug count    
       ...
       [err, species, obsv_equil] = model_bigmech_test(t,init,params);
...
%         init(2) = par(2);
    ...
    [err, species, obsv] = model_tcemodel_bigmech_testll_v26(t,init,par);
...
tit={'PTEN','PTEN mRNA','Akt_p308','Akt_p473','FoxO1_p','Total FoxO1','Active FoxO1','Total Akt'};
